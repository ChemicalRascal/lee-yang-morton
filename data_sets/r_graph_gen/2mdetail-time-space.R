...
p <- p + scale_y_continuous(name="Time per 8k queries [s]",limits=c(NA,1000))#,breaks=seq(0,6,0.5))
...
p <- p + scale_x_continuous(trans="log2",name="Memory consumed [MiB]",breaks=seq(1*1024*1024,15*1024*1024,0.5*1024*1024),limits=c(5.5*1024*1024,7*1024*1024),labels=seq(1,15,0.5))
...
p <- p + ggtitle("Time/Space on allCountries.2mr: Detail")

figWidth=4.25
figHeight=2.50
filename <- "2m-detail-time-space.png"
